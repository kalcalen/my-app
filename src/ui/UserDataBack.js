            ...
            <table className="table table-sm">
               ...
               <tbody>
                  <tr>
                     ...
                     <td>
                        <label display={memoryCard.availability.tuesday.am11}>
                           X
                        </label>
                     </td>
                     <td>
                        <label display={memoryCard.availability.wednesday.am11}>
                           X
                        </label>
                     </td>
                     <td>
                        <label display={memoryCard.availability.thursday.am11}>
                           X
                        </label>
                     </td>
                     <td>
                     ...
                     <td>
                        <label display={memoryCard.availability.saturday.am11}>
                           X
                        </label>
                     </td>
                  </tr>
